...
# 🎮 Path of Idle: Old Gods Rising — Community Edition

**Idle RPG of forgotten gods — standalone offline Community Edition.**
...
Path of Idle: Old Gods Rising is an idle RPG set in a world where forgotten deities stir beneath the land. Progress continues while you are away, combining resource management, talent trees, and mythological boss encounters. This Community Edition is a standalone, self-contained package that runs offline with no storefront required.

This standalone build is for fans of idle and incremental RPGs who want a self-contained offline release for Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4243990/18cfe81da973241b7cd3b9fc2bb6d8242d398b32/ss_18cfe81da973241b7cd3b9fc2bb6d8242d398b32.1920x1080.jpg?t=1786667366" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4243990/d364335c7c917e616925e5d9ad88d8844ea9a8ea/ss_d364335c7c917e616925e5d9ad88d8844ea9a8ea.1920x1080.jpg?t=1786667366" alt="Screenshot 2" width="100%"></td>
...
- **Interface:** English, German, French, Spanish, Russian, Simplified Chinese, Portuguese-Brazil, Japanese
- **Voiceover:** English
...
- ⏳ **Idle Progression** — Resources accumulate and battles resolve while the game is closed or minimized.
- 👹 **Old Gods Pantheon** — Face over 40 mythological boss entities across escalating world tiers.
- 🌳 **Deep Talent Trees** — Three branching skill trees with more than 200 nodes to respec and optimize.
- ⚔️ **Auto-Battle System** — Configurable combat routines with priority targeting and ability rotation scripting.
- 🏺 **Relic Crafting** — Forge and enchant relics from materials harvested across five regions.
- 📈 **Prestige Cycles** — Reset runs for permanent ascension points and unlockable meta-perks.
- 💾 **Offline Save Support** — Fully offline play with local saves; no account or internet connection needed.
- 🖱️ **Low-Resource Footprint** — Runs quietly in the background on modest hardware without heavy GPU demands.
- 🌌 **Five Regions** — Explore drowned temples, ash wastes, and the sunken vaults of the rising gods.
- 🏆 **Achievement Set** — 80 in-game achievements with milestone rewards for long-term idle runs.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional voice-over pack and high-resolution art assets can be skipped during installation

---

## 📦 DLCs Included

- Old Gods Rising: Tidebound Depths
- Old Gods Rising: Ashen Crown
- Old Gods Rising: Supporter Relic Pack
...
| **Processor** | Intel Core i3-4130 or AMD Athlon 3000G | Intel Core i5-8400 or AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD 4600 or equivalent integrated graphics | NVIDIA GeForce GTX 1050 or AMD Radeon RX 560 |
| **Storage** | 2 GB available space | 2 GB available space on SSD |
| **Additional** | No additional software required | No additional software required |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\PathofIdle:OldGodsRising\Saved`
